...
export const COUNTRY_DATA: Record<number, {
  ...
  702:{name:'Singapore',score:0.63,sig:'BULL',sector:'Finance / Trade',trend:'↑',headlines:['MAS holds rates as inflation eases','SGX hits record volumes','Singapore GDP beats at 3.1% Q1'],ai:'Singapore is bullish. Its role as Asia\'s premier financial hub benefits from capital rotation out of China. Strong trade flows and MAS stability make it a safe-haven play in the region.'},
  682:{name:'Saudi Arabia',score:0.41,sig:'BULL',sector:'Energy / Vision 2030',trend:'↑',headlines:['Aramco raises dividend payout','Vision 2030 mega-projects accelerate','Tadawul hits 12,000 milestone'],ai:'Saudi Arabia shows bullish signals. Elevated oil revenues fund Vision 2030 diversification at pace. Aramco\'s dividend policy and rising foreign investment make Tadawul increasingly attractive.'},
  784:{name:'UAE',score:0.58,sig:'BULL',sector:'Finance / Real Estate',trend:'↑',headlines:['Dubai property prices up 22% YoY','Abu Dhabi ADNOC expansion on track','UAE attracts record $30B FDI'],ai:'UAE is strongly bullish. Dubai real estate at multi-year highs driven by wealth migration. ADNOC\'s downstream expansion and record FDI inflows provide diversified economic momentum.'},
  710:{name:'South Africa',score:-0.34,sig:'BEAR',sector:'Mining / Utilities',trend:'↓',headlines:['Load-shedding hits record stage 6','Rand weakens on current account deficit','JSE mining sector underperforms'],ai:'South Africa is bearish. Structural power supply failures continue to suppress industrial output. The Rand remains under pressure and the JSE mining sector reflects commodity demand uncertainty.'},
  792:{name:'Turkey',score:-0.61,sig:'BEAR',sector:'Finance / Consumer',trend:'↓',headlines:['Inflation accelerates to 67%','CBRT holds despite lira pressure','Istanbul property market cools sharply'],ai:'Turkey shows bearish signals. Persistent elevated inflation and unorthodox monetary policy undermine investor confidence. The lira remains structurally weak despite CBRT intervention.'},
  756:{name:'Switzerland',score:0.48,sig:'BULL',sector:'Finance / Pharma',trend:'↑',headlines:['SNB cuts rates to 1.25%','UBS integration of Credit Suisse on track','Swiss exports resilient despite CHF strength'],ai:'Switzerland is moderately bullish. SNB rate cuts support equities and CHF-denominated assets. The UBS-Credit Suisse integration is proceeding faster than expected, restoring banking sector confidence.'},
  484:{name:'Mexico',score:0.21,sig:'NEUT',sector:'Manufacturing / Nearshoring',trend:'→',headlines:['Nearshoring boom drives industrial REIT surge','Banxico holds rates at 11%','Peso consolidates after record highs'],ai:'Mexico is neutral-to-positive. Nearshoring demand from US corporates is a structural tailwind for industrial real estate. Banxico\'s cautious stance supports the Peso but limits equity upside.'},
  360:{name:'Indonesia',score:0.34,sig:'BULL',sector:'Commodities / Digital',trend:'↑',headlines:['BI holds rates, signals easing path','Nickel exports drive current account surplus','Jakarta Composite hits all-time high'],ai:'Indonesia is moderately bullish. Nickel and palm oil export strength supports the Rupiah. Bank Indonesia\'s clear easing signaling and a young digital-native consumer base create a constructive outlook.'},
  380:{name:'Italy',score:-0.19,sig:'NEUT',sector:'Luxury / Finance',trend:'→',headlines:['Italy GDP growth misses at 0.4%','BTP-Bund spread widens on fiscal concerns','Luxury exports soft on China slowdown'],ai:'Italy is neutral. Sluggish GDP growth and fiscal deficit concerns cap upside. The luxury sector faces headwinds from China demand softness, though domestic tourism revenues provide an offset.'},
  616:{name:'Poland',score:0.31,sig:'BULL',sector:'Manufacturing / Finance',trend:'↑',headlines:['NBP signals rate cut in H2','Warsaw WIG20 outperforms EU peers','Poland attracts record EU cohesion funds'],ai:'Poland shows mild bullish signals. Significant EU structural fund inflows, falling inflation, and rate cut expectations support both equities and consumer sentiment in 2024.'},
  818:{name:'Egypt',score:-0.52,sig:'BEAR',sector:'Tourism / FX',trend:'↓',headlines:['EGP depreciates 38% since floatation','IMF deal disbursement delayed','Tourism revenues miss target by 18%'],ai:'Egypt is bearish. Sharp currency devaluation following the IMF-linked EGP float is squeezing imports and consumer purchasing power. FX reserve rebuild remains slow and fragile.'},
};
